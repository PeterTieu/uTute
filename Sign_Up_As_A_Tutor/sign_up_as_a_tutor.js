...
// Create a div and render it to the page
// Parameters:
// divTemplate: The ID of the div template to create
// createdDiv: The ID of the div for which to create the template at
